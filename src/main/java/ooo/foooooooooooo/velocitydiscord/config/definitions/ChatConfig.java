...
public class ChatConfig {
  ...
  public UserMessageConfig advancement = new UserMessageConfig("**{username} has made the advancement __{advancement_title}__**\n_{advancement_description}_", Config.GREEN);

  public UserMessageConfig serverSwitch = new UserMessageConfig("**{username} moved to {current} from {previous}**", Config.GREEN);
