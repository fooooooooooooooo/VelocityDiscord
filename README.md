...
# {playerCount} - Total number of players online
# {playerList} - List of player usernames
# {playerPingList} - List of player pings with latency
# {serverCount} - Number of servers
# {serverList} - List of server names
# {hostname} - Server hostname
# {port} - Server port
# {queryMotd} - Message of the Day (MOTD)
# {queryMap} - Custom key-value pairs for the server
# {queryPort} - Query port
# {queryMaxPlayers} - Maximum number of players
# {pluginCount} - Number of plugins
# {pluginList} - List of plugin names
# {version} - Server version
# {software} - Software name
# {averagePing} - Average ping of all players
...
topic_format = """Player count: {playerCount} | Players: {playerList} | Pings: {playerPingList} | \
Server count: {serverCount} | Servers: {serverList} | {server[lobby]} | {server[survival]} | \
Hostname: {hostname} | Port: {port} | MOTD: {queryMotd} | Query map: {queryMap} | \
Query port: {queryPort} | Max players: {queryMaxPlayers} | Plugin count: {pluginCount} | \
Plugins: {pluginList} | Version: {version} | Software: {software} | Average ping: {averagePing} | \
Uptime: {uptime}"""
...
# Placeholder {server} is available
# Can be disabled
